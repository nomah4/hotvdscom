...
export const dictionaries = {
  ru: { common: ruCommon, home: ruHome, pricing: ruPricing, dashboard: ruDashboard, legal: ruLegal },
  en: { common: enCommon, home: enHome, pricing: enPricing, dashboard: enDashboard, legal: enLegal },
};
