...
export const pricing = {
  ...
  checkout: {
    ...
    balanceCovers: 'This order will be paid from your balance ({balance} available). No card needed.',
    payFromBalance: 'Pay from balance',
    balanceShortfall: 'Top up {amount} more to pay from your balance',
    balanceShortfallNote: 'After topping up, come back to this page and confirm the order — a new purchase is not paid automatically.',
